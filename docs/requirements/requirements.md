...
- **Release 8.3** (Calendar Integration — Tapahtumakalenteri): 9 requirements — 3 ✅ (CAL-1, CAL-2, CAL-3), 6 pending (CAL-4–CAL-6, MP3 gap analysis, MP8 localization, MP9 branding). Migrates PowerShell calendar scripts to Node.js platform. Subsumes R47, supersedes R41. MP3/MP8/MP9 moved from R8.1
