...
- **Release 8.3** (Calendar Integration — Tapahtumakalenteri): 6 requirements — 0 ✅, 6 pending (CAL-1–CAL-6). Migrates PowerShell calendar scripts to Node.js platform. Subsumes R47, supersedes R41
