...
- **Release 9.2** (SSI Discipline Registry): 4 requirements — 3 ✅ (SSI-R1, SSI-R2, SSI-R4), 1 design (SSI-R3). Built-in registry of SSI discipline types replacing manual URL entry
