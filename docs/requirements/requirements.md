...
- **Release 8.3** (Calendar Integration — Tapahtumakalenteri): 9 requirements — 8 ✅ (CAL-1–CAL-7, MP8, MP9), 1 pending (MP3 gap analysis). Migrates PowerShell calendar scripts to Node.js platform. Subsumes R47, supersedes R41. MP3/MP8/MP9 moved from R8.1
