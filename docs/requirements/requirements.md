...
- **Release 8.2.1** (Architecture Technical Debt — Patch): 23 requirements — 15 ✅ (LOG-1, COD-1, COD-2, COD-4, TST-7, MOD-1, MOD-2, MOD-3, MOD-4, MOD-5, TST-1, TST-2, TST-3, TST-4, ARC-2), 8 ⬚ pending (MOD-6–8, COD-3, TST-5, TST-6, TST-8, ARC-1)
