...
- **Release 9.2** (SSI Discipline Registry): 4 requirements — 2 ✅ (SSI-R1, SSI-R2), 2 design (SSI-R3, SSI-R4). Built-in registry of SSI discipline types replacing manual URL entry
