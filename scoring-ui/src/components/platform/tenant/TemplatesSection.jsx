// TemplatesSection — event blueprints for each discipline

import { useState, useEffect } from 'react'
import { listTemplates, listDisciplines, createTemplateApi, updateTemplateApi, deleteTemplateApi, importTemplateSeed } from '../../../platform-api.js'
...
export default function TemplatesSection({ tenantId, onEditTemplate }) {
