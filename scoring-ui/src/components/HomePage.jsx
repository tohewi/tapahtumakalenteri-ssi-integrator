...
const features = [
  {
    href: '#/scoring',
    titleKey: 'scoringTitle',
    descriptionKey: 'scoringDescription',
    icon: (
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="font-semibold text-gray-800 text-lg">{t[f.titleKey]}</div>
                <div className="text-sm text-gray-500 mt-0.5">{t[f.descriptionKey]}</div>
              </div>
