...
// Usage:
//   node test-seed-import.mjs --base-url http://localhost:3001 \
...
if (!EMAIL || !PASSWORD || !TENANT_ID || !TEMPLATE_ID) {
  console.error('Usage: node test-seed-import.mjs --base-url <url> --email <email> --password <password> --tenant-id <id> --template-id <id>')
