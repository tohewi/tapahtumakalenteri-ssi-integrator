...
function requireAdminKey() {
  return (req, res, next) => {
    ...
    if (!adminKey) {
      log.warn('[admin] ADMIN_API_KEY not configured ΓÇö admin endpoints disabled')
...
export function createAdminRouter() {
  ...
  // GET /api/v1/admin/tenants ΓÇö list all tenants with owner info
  ...
  // GET /api/v1/admin/accounts ΓÇö list all accounts
  ...
  // GET /api/v1/admin/sessions ΓÇö session statistics
  ...
  // DELETE /api/v1/admin/tenants/:id ΓÇö delete a tenant and all associated data
  ...
  // DELETE /api/v1/admin/accounts/:id ΓÇö delete an account and all owned tenants
  ...
  // GET /api/v1/admin/overview ΓÇö combined dashboard data
